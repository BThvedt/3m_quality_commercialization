...
export type CommercializationRole =
  | "quality"
...
export type SuspendedData = {
  ...
  completed: boolean[]
  lastLogin: string
  lockedSections: Record<CommercializationRole, boolean[]>
  completedSections: Record<CommercializationRole, boolean[]>
  currentRole: CommercializationRole | ""
}
