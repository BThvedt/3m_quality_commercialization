<template>
  <PageBase>
    <div id="development" class="module-page-container">
      <HeadlineAndResults
      ...
      <IntroConclusionModal
        ref="developmentConclusion"
        :titleAndText="developmentConclusion"
...
export default Vue.extend({
  ...
  data() {
    return {
      ...
      developmentConclusion: this.json.developmentConclusion,
  ...
  methods: {
    ...
    async checkIfDone() {
      if (!this.subActivitiesDone.includes(false)) {
        await genericAwait(1000)
        ;(this.$refs["developmentConclusion"] as any).show()
      }
    },
