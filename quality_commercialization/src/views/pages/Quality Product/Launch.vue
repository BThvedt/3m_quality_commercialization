<template>
  <PageBase>
    <div id="launch" class="module-page-container">
      <HeadlineAndResults
      ...
      <IntroConclusionModal
        ref="launchConclusion"
        :titleAndText="launchConclusion"
...
export default Vue.extend({
  ...
  data() {
    return {
      ...
      launchConclusion: this.json.launchConclusion,
  ...
  methods: {
    ...
    async checkIfDone() {
      if (!this.subActivitiesDone.includes(false)) {
        await genericAwait(1000)
        ;(this.$refs["launchConclusion"] as any).show()
      }
    },
